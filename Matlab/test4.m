...
%% Ustawienia filtracji
    ...
    a = 2*cos(w);
    a_test = a;
    u = 10e-7  ;            %wielkosc kroku  (ma³a ma byæ)!!!    jest przemno¿ona przez 2                  !!!!!!!!!!wielkosc kroku
...
%% Wyswietlanie wykresow
    ...
    plot(t,aa(:,3));
    plot(t,aa(:,4));
    legend('r=0.997','r=0.9975','r=0.998','r=0.9985')
